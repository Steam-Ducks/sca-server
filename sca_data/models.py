...
class SilverPrograma(models.Model):
    ...
    gerente_tecnico = models.CharField(max_length=100, blank=True)
...
class SilverProjeto(models.Model):
    ...
    nome_projeto = models.CharField(max_length=100, blank=True)
...
class GoldCosts(models.Model):
    ...
    nome_programa = models.CharField(max_length=100, blank=True)
    gerente_programa = models.CharField(max_length=100, blank=True)
    nome_projeto = models.CharField(max_length=100, blank=True)
    responsavel_projeto = models.CharField(max_length=100, blank=True)
...
class GoldBudgetSnapshot(models.Model):
    ...
    saude_financeira = models.CharField(max_length=20, blank=True)
