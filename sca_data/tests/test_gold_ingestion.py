...
class TestRunPipeline:
    ...
    @patch("sca_data.analysis._run_costs")
    @patch("sca_data.analysis._run_materials_indicators")
    ...
    @patch("sca_data.analysis._run_costs", side_effect=RuntimeError("costs failed"))
    @patch("sca_data.analysis._run_materials_indicators")
