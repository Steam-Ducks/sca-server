...
_TAREFAS = [
    {
        ...
        "estimativa_horas": 40,
        "data_inicio": date(2024, 2, 1),
        "data_fim_prevista": date(2024, 2, 15),
        "status": "Concluída",
    },
    {
        "id": 2,
        "codigo_tarefa": "T-002",
        "projeto_id": 1,
        "titulo": "Desenvolvimento do firmware",
        "responsavel": "Bruno Ferreira",
        "estimativa_horas": 120,
        "data_inicio": date(2024, 2, 16),
    ...
    },
    {
        ...
        "codigo_tarefa": "T-004",
        "projeto_id": 2,
        "titulo": "Implementação algoritmo PID",
        "responsavel": "Camila Torres",
        "estimativa_horas": 80,
        "data_inicio": date(2024, 5, 1),
        "data_fim_prevista": date(2024, 8, 31),
        "status": "Em andamento",
    },
    {
        "id": 5,
        "codigo_tarefa": "T-005",
        "projeto_id": 4,
        "titulo": "Design do esquemático",
        "responsavel": "Elena Barbosa",
        "estimativa_horas": 50,
        "data_inicio": date(2024, 3, 1),
        "data_fim_prevista": date(2024, 4, 15),
        "status": "Concluída",
    },
    {
        "id": 6,
        ...
        "estimativa_horas": 90,
        "data_inicio": date(2024, 5, 1),
        "data_fim_prevista": date(2024, 9, 30),
        "status": "Em andamento",
    },
    {
        "id": 7,
    ...
    },
    {
        ...
        "codigo_tarefa": "T-008",
        "projeto_id": 7,
        "titulo": "Calibração do sensor",
        "responsavel": "Hugo Pereira",
        "estimativa_horas": 30,
        "data_inicio": date(2023, 6, 1),
        "data_fim_prevista": date(2023, 8, 31),
        "status": "Concluída",
    },
]
...
_PEDIDOS_COMPRA = [
    {
        ...
        "data_previsao_entrega": date(2024, 3, 20),
        "valor_total": 45000.0,
        "status": "Recebido",
    },
    {
        "id": 2,
        "numero_pedido": "PC-2024-002",
        "solicitacao_id": None,
        "fornecedor_id": 2,
        "data_pedido": date(2024, 3, 10),
        "data_previsao_entrega": date(2024, 4, 10),
        "valor_total": 32000.0,
        "status": "Recebido",
    },
    {
        "id": 3,
        "numero_pedido": "PC-2024-003",
        "solicitacao_id": None,
        "fornecedor_id": 3,
        "data_pedido": date(2024, 4, 5),
        "data_previsao_entrega": date(2024, 5, 5),
        "valor_total": 78000.0,
        "status": "Em trânsito",
    },
    {
        "id": 4,
        "numero_pedido": "PC-2024-004",
        "solicitacao_id": None,
        "fornecedor_id": 1,
        "data_pedido": date(2024, 5, 15),
        "data_previsao_entrega": date(2024, 6, 15),
        "valor_total": 55000.0,
        "status": "Recebido",
    },
    {
        "id": 5,
        "numero_pedido": "PC-2024-005",
        "solicitacao_id": None,
        "fornecedor_id": 2,
        "data_pedido": date(2024, 6, 1),
        "data_previsao_entrega": date(2024, 7, 1),
        "valor_total": 29000.0,
        "status": "Recebido",
    },
    {
        "id": 6,
        "numero_pedido": "PC-2024-006",
        "solicitacao_id": None,
        "fornecedor_id": 3,
        "data_pedido": date(2024, 7, 10),
        "data_previsao_entrega": date(2024, 8, 10),
        "valor_total": 91000.0,
        "status": "Em processamento",
    },
    {
        "id": 7,
        "numero_pedido": "PC-2023-001",
        "solicitacao_id": None,
        "fornecedor_id": 1,
        "data_pedido": date(2023, 7, 1),
        "data_previsao_entrega": date(2023, 8, 1),
        "valor_total": 18000.0,
        "status": "Recebido",
    },
    {
        "id": 8,
        "numero_pedido": "PC-2023-002",
        "solicitacao_id": None,
        "fornecedor_id": 2,
        "data_pedido": date(2023, 9, 1),
        "data_previsao_entrega": date(2023, 10, 1),
        "valor_total": 22000.0,
        "status": "Recebido",
    },
]
...
class Command(BaseCommand):
    ...
    def handle(self, *_args, **options):
        ...
        with transaction.atomic():
            ...
            counts = {
                "programa(s)": _seed_model(
                    prog_cls, _PROGRAMAS, now, "programa(s)", self.stdout
                ),
                "fornecedor(s)": _seed_model(
                    forn_cls, _FORNECEDORES, now, "fornecedor(es)", self.stdout
                ),
                "projeto(s)": _seed_model(
                    proj_cls, _PROJETOS, now, "projeto(s)", self.stdout
                ),
                "tarefa(s)": _seed_model(
                    tarefa_cls, _TAREFAS, now, "tarefa(s)", self.stdout
                ),
                "tempo(s)": _seed_model(
                    tempo_cls, _TEMPOS, now, "registro(s) de tempo", self.stdout
                ),
                "pedido(s)": _seed_model(
                    pedido_cls, _PEDIDOS_COMPRA, now, "pedido(s) de compra", self.stdout
                ),
                "compra(s)": _seed_model(
                    compra_cls, _COMPRAS_PROJETO, now, "alocação(ões)", self.stdout
                ),
            }
    ...
    def _seed_users(self, user_cls):
        ...
        for u in _DEV_USERS:
            ...
            _, was_created = user_cls.objects.get_or_create(
